          ...
          <div className="MainDash">
            ...
            <div className="AssMantTop">
              ...
              <button type="button" data-bs-toggle="modal" data-bs-target="#DashModall">
                <img src={Topic} alt="Topic" /> Assessment Catalogue
              </button>
            </div>
            ...
            <div className="overviewDiv">
                ...
                <div className="overviewitem">
                    <BoxDiv boximg={box4} ovradcls=" fawndark" ovrtxt="New Appointments"  boxcoltext="frowntext" overnumb="12"   />
                    <BoxDiv boximg={box5} ovradcls=" cambrageblue" ovrtxt="Completed" boxcoltext="greentext" overnumb="08"  />
                    <BoxDiv boximg={box2} ovradcls=" purple" ovrtxt="Pending" boxcoltext="purpletext" overnumb="02"  />
                </div>
            </div>
                ...
                <div className="DashCardData">
                    ...
                    <div className="DashCardDiv">
                        ...
                        <div className="DashCardItem fawnbg">
                            <AppointCard crdimg={pet1} cdowner="Kizie" crdtpe="Sky B" btnimg={btn1} btntext="Tuesday, 10 Sep - 11:00 AM" crddoctor="Dr. Emily Johnson" drjob="Cardiology" CardbtnClass="btnfown"/>
                            <AppointCard crdimg={pet1} cdowner="Max" crdtpe="David Martin" btnimg={btn1} btntext="Tuesday, 10 Sep - 11:00 AM" crddoctor="Dr. Olivia Harris" drjob="Neurology" CardbtnClass="btnfown"/>
                            <AppointCard crdimg={pet1} cdowner="Molly" crdtpe="Lucas Miller" btnimg={btn1} btntext="Tuesday, 10 Sep - 11:00 AM" crddoctor="Dr. Grace Walker" drjob="Dentistry" CardbtnClass="btnfown"/>
                        </div>
                    </div>
                    ...
                    <div className="DashCardDiv">
                        ...
                        <div className="DashCardItem greenbg">
                            <AppointCard crdimg={pet1} cdowner="Bella" crdtpe="Sarah Johnson" btnimg={btn3} btntext="Tuesday, 10 Sep - 11:00 AM" crddoctor="Dr. Michael Lee" drjob="Orthopedics" CardbtnClass="btngreen"/>
                            <AppointCard crdimg={pet1} cdowner="Max" crdtpe="David Martin" btnimg={btn3} btntext="Tuesday, 10 Sep - 11:00 AM" crddoctor="Dr. Olivia Harris" drjob="Neurology" CardbtnClass="btngreen"/>
                            <AppointCard crdimg={pet1} cdowner="Max" crdtpe="David Martin" btnimg={btn3} btntext="Tuesday, 10 Sep - 11:00 AM" crddoctor="Dr. Olivia Harris" drjob="Neurology" CardbtnClass="btngreen"/>
                        </div>
                    </div>
                    ...
                    <div className="DashCardDiv">
                        ...
                        <div className="DashCardItem chillybg">
                            <AppointCard crdimg={pet1} cdowner="Bella" crdtpe="Sarah Johnson" btnimg={btn4} btntext="Tuesday, 10 Sep - 11:00 AM" crddoctor="Dr. Michael Lee" drjob="Orthopedics" CardbtnClass="btnchilly"/>
                            <AppointCard crdimg={pet1} cdowner="Max" crdtpe="David Martin" btnimg={btn4} btntext="Tuesday, 10 Sep - 11:00 AM" crddoctor="Dr. Olivia Harris" drjob="Neurology" CardbtnClass="btnchilly"/>
                        </div>
                    </div>
