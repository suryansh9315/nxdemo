              ...
              <div className="blogPicLeft">
                <div className="Blogpic">
                  ...
                  <div className="bloginner">
                    ...
                    <p>You want to give your puppy a warm welcome to their new home. However, buying for your puppy can be overwhelming when you don’t know where to begin. There are many things to know about caring for your new fur baby...</p>
                  </div>
                </div>
              </div>
            ...
            <div className="BlogExploreDiv">
              <div className="topExplore">
                ...
                <div className="Searchbar">
                    <input type="text" id="searchQueryInput" name="searchQueryInput" className="form-control" placeholder="Search by Topic" aria-label="Username" aria-describedby="basic-addon1"/>
                    <button id="searchQuerySubmit" type="submit" name="searchQuerySubmit" ><i className="ri-search-line"></i></button>
                </div>
              </div>
              <div className="ExploreData">
                <ExploreType/>
                <div className="ExploreCardData">
                  <ExplrCard  expimg={cardpuppy1} stnme="Skin Care" stmint="5 mins read" Extext="5 Home Remedies for Your Dog’s Itchy Skin" drimg={drf} drname="Dr. Jamie Sailor" drdays="2 days ago" />
                  <ExplrCard  expimg={cardpuppy2} stnme="Senior Cats" stmint="8 mins read" Extext="When Is a Cat Considered a Senior? What To Expect When Your Cat’s Aging" drimg={drf} drname="Dr. Ken Morrison" drdays="Sep 25, 2024" />
                  <ExplrCard  expimg={cardpuppy3} stnme="Nutrition" stmint="5 mins read" Extext="What Are Cat Supplements and How Do They Work?" drimg={drf} drname="Dr. John David" drdays="Sep 18, 2024" />
                  <ExplrCard  expimg={cardpuppy4} stnme="Healthy Living" stmint="5 mins read" Extext="Winter Care for Horses" drimg={drf} drname="Dr. Lisa Maiden" drdays="2 days ago" />
                  <ExplrCard  expimg={cardpuppy5} stnme="Skin Care" stmint="5 mins read" Extext="Dog Not Drinking Water? Possible Causes and When To Call Your Vet" drimg={drf} drname="Dr. Benny David" drdays="Aug 30, 2024" />
                  <ExplrCard  expimg={cardpuppy6} stnme="Wellness" stmint="5 mins read" Extext="Why Horse Rearing Happens and How To Stop It" drimg={drf} drname="Dr. Susan Martin" drdays="Aug 18, 2024" />
                </div>
              </div>
            </div>
          </div>
...
export function ExplrCard({ expimg , stnme , stmint ,Extext ,drimg ,drname , drdays  }) {
  return <div className="explCard">
...
export function MBTN({BICON , BNAME}) {
  return <div className="Mbtn">
    <button>{BICON} {BNAME}</button>
  </div>;
}
